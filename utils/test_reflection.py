...
def get_atomic_number(symbol):
    # 空白を削除し、大文字に統一して検索
    return atom_symbol_to_number.get(symbol.strip(), "Invalid atom symbol")

# 使用例
print(get_atomic_number("N "))  
...
dat = [
    ...
    '_atom_site_fract_y        ',
    '_atom_site_fract_z        ',
    'Co 0.00265771 0.00000000 0.00000000',  # Coは重いので小さめの値
    'Tl 0.50015703 0.50000000 0.50000000',  # Tlも重いので小さめの値
    'N1 0.50108143 0.00000000 0.50000000',  # Nは軽いので大きめの値
    'N2 0.50108143 0.50000000 0.00000000',  # Nの別の位置でも同様
    'O 0.00050506 0.50000000 0.50000000'    # 他の軽い原子も少し大きめ
]
