...
def calculate_loss(batch, traj, c):
    batch_y = calculate_y_vectorized_re(batch, c)
    traj_y = calculate_y_vectorized_re(traj, c)
...
def calculate_dellogp_delx_t_with_all_flow(x_t, pred_x, pred_x_d2, sigma_x, batch):
    ...
    delI_delm_delm_delx_t = calculate_delI_delm_delx_t_vectorized(batch, m, c, delm_delx)
    ...
    delI_delc_delc_delx_t = calculate_delI_delc_delx_t_vectorized(batch, m, c, delc_delx)
